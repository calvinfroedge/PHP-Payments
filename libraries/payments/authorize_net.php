...
{		
	...
	*/		
	public function __construct($payments)
	{
		...
		$this->_default_params = $this->payments->default_params;
		$this->_api_endpoint = $this->payments->config->module['api_endpoint'.'_'.$this->payments->mode];
		$this->_api_settings = array(
			'login'			=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_username'] : $this->payments->config->module['api_username'],
			'tran_key'		=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_password'] : $this->payments->config->module['api_password'],
			'xml_version'	=> '1.0',
			'encoding'		=> 'utf-8',
