	...
	*/		
	public function __construct($payments)
	{
		...
		$this->_api_settings = array(
			...
			'password'		=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['password'] : $this->payments->config->module['api_password'],
			'requestType'	=> 'BACKEND'
		);
		
		$this->_validation = array(
			'username' => $this->payments->config->module['validation_username'],
			'password' => $this->payments->config->module['validation_password']
		);	
	}
