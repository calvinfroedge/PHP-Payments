...
class Bluepay {
	...
	public function __construct($payments)
	{
		...
		$this->_api_endpoint = $this->payments->config->module['api_endpoint'];	
		$this->_api_version = $this->payments->config->module['api_version'];	
		$this->_payment_to_gateway_key_map = $this->payments->config->module['payment_to_gateway_key_map'];		
		$this->_api_settings = (object) array(
			'login'			=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_account_id'] : $this->payments->config->module['api_account_id'],
			'user_id'		=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_user_id'] : $this->payments->config->module['api_user_id'],
			'secret_key'	=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_secret_key'] : $this->payments->config->module['api_secret_key'],
			'test_mode'		=> $this->payments->config->module['test_mode']
		);
	}
