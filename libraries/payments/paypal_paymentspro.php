	...
	*/		
	public function __construct($payments)
	{
		...
		$this->_api_settings = array(
			'USER'	=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_username'] : $this->payments->config->module['api_username'],
			'PWD'	=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_password'] : $this->payments->config->module['api_password'],
			'VERSION' => $this->payments->config->module['api_version'],
			'SIGNATURE'	=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_signature'] : $this->payments->config->module['api_signature']	
		);
	}
