	...
	*/		
	public function __construct($payments)
	{
		...
		$this->_api_settings = array(
			...
			'connection_ticket'	=> (isset($payments->gateway_credentials)) ? $payments->gateway_credentials['api_connection_ticket'] : $this->payments->config->module['api_connection_ticket'],
			'xml_version'	=> '1.0',
			'encoding'		=> 'utf-8',
			'xml_extra'		=> $this->payments->config->module['api_qbxml']
		);
	}
